...
/**
 * Implements hook_foÏrm_FORM_ID_alter().
 *
 * @param $form
 *   The form.
 * @param $form_state
 *   The form state.
 */
function elmcip_elo_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['mtt_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('ELMCIP ELO Theme Settings'),
    '#collapsible' => FALSE,
    '#collapsed' => FALSE,
  );
  ...
  $form['mtt_settings']['tabs']['looknfeel']['theme_colors']['theme_color'] = array(
    ...
    '#default_value' => theme_get_setting('theme_color', 'elmcip_elo'),
    '#options' => array(
      'default' => t('Default'),
  ...
  $form['mtt_settings']['tabs']['looknfeel']['buttons']['button_color'] = array(
    ...
    '#title' => t('Colors'),
    '#description'   => t('From the drop-down menu, select the color scheme you prefer.'),
    '#default_value' => theme_get_setting('button_color', 'elmcip_elo'),
    '#options' => array(
      'blue' => t('Blue'),
  ...
  $form['mtt_settings']['tabs']['plugins']['header_tooltip']['social_icons_display'] = array(
    ...
    '#default_value' => theme_get_setting('social_icons_display', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['header_tooltip']['header_tooltip_js'] = array(
    ...
    '#default_value' => theme_get_setting('header_tooltip_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['main_menu']['main_menu_custom_js'] = array(
    ...
    '#default_value' => theme_get_setting('main_menu_custom_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_display'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_display', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_js'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['slideshow']['slideshow_effect'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_effect', 'elmcip_elo'),
    '#options' => array(
    'slide' => t('Slide'),
    'fade' => t('Fade'),
    ),
  ...
  $form['mtt_settings']['tabs']['plugins']['highlighted']['highlighted_display'] = array(
    ...
    '#default_value' => theme_get_setting('highlighted_display', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_display'] = array(
    ...
    '#default_value' => theme_get_setting('carousel_display', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_js'] = array(
    ...
    '#default_value' => theme_get_setting('carousel_js', 'elmcip_elo'),
  );

  $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_effect_time'] = array(
    '#type' => 'textfield',
    '#title' => t('Effect duration (sec)'),
    '#default_value' => theme_get_setting('carousel_effect_time', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['carousel']['carousel_effect'] = array(
    ...
    '#default_value' => theme_get_setting('carousel_effect', 'elmcip_elo'),
    '#options' => array(
      'linear' => 'linear',
      'swing' => 'swing',
  ...
  $form['mtt_settings']['tabs']['plugins']['quicksand']['quicksand_js'] = array(
    ...
    '#default_value' => theme_get_setting('quicksand_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_js'] = array(
    ...
    '#default_value' => theme_get_setting('prettyphoto_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_theme'] = array(
    ...
    '#default_value' => theme_get_setting('prettyphoto_theme', 'elmcip_elo'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['plugins']['prettyphoto']['prettyphoto_social_tools'] = array(
    ...
    '#default_value' => theme_get_setting('prettyphoto_social_tools', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['jtweetanywhere']['jtweetanywhere_js'] = array(
    ...
    '#default_value' => theme_get_setting('jtweetanywhere_js', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['plugins']['jtweetanywhere']['jtweetanywhere_id'] = array(
    ...
    '#default_value' => theme_get_setting('jtweetanywhere_id', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['shortcodes']['columns']['columns_enable'] = array(
    ...
    '#default_value' => theme_get_setting('columns_enable', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['shortcodes']['boxes']['boxes_enable'] = array(
    ...
    '#default_value' => theme_get_setting('boxes_enable', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['shortcodes']['lists']['lists_enable'] = array(
    ...
    '#default_value' => theme_get_setting('lists_enable', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['breadcrumb']['breadcrumb_display'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_display', 'elmcip_elo'),
  );

  $form['mtt_settings']['tabs']['breadcrumb']['breadcrumb_separator'] = array(
    '#type' => 'textfield',
    '#title' => t('Breadcrumb separator'),
    '#default_value' => theme_get_setting('breadcrumb_separator', 'elmcip_elo'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  ...
  $form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_state'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_menu_state', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_switchwidth'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_menu_switchwidth', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['support']['responsive']['responsive_menu']['responsive_menu_topoptiontext'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['support']['responsive']['responsive_meta'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_meta', 'elmcip_elo'),
  );
  ...
  $form['mtt_settings']['tabs']['support']['responsive']['responsive_respond'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_respond', 'elmcip_elo'),
